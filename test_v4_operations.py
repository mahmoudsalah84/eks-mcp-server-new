#!/usr/bin/env python3
"""
Test script for EKS MCP Server V4 operations
"""
...
SERVER_URL = "http://54.160.166.213:8000"
...
def main():
    """Main function"""
    print("Starting EKS MCP Server V4 operations test")
    ...
    print("\n=== Test Summary ===")
    print("✅ Completed testing all V4 operations")
