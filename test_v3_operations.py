#!/usr/bin/env python3
"""
Test script for EKS MCP Server V3 operations
"""
...
SERVER_URL = "http://34.204.193.239:8000"
...
def main():
    """Main function"""
    print("Starting EKS MCP Server V3 operations test")
    ...
    print("\n=== Test Summary ===")
    print("✅ Completed testing all V3 operations")
